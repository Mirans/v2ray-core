...
func TestSimpleRouter(t *testing.T) {
	...
	ctx := session.ContextWithOutbound(context.Background(), &session.Outbound{Target: net.TCPDestination(net.DomainAddress("github.com/v2ray/v2ray-core"), 80)})
...
func TestIPOnDemand(t *testing.T) {
	...
	mockDns := mocks.NewDNSClient(mockCtl)
	mockDns.EXPECT().LookupIP(gomock.Eq("github.com/v2ray/v2ray-core")).Return([]net.IP{{192, 168, 0, 1}}, nil).AnyTimes()
