	...
	cases := []struct {
	...
	}{
		{
			rule: &RoutingRule{
				Domain: []*Domain{
					{
						Value: "github.com/v2ray/v2ray-core",
						Type:  Domain_Plain,
					},
					{
						Value: "google.com",
			...
			test: []ruleTest{
				{
					input:  withOutbound(&session.Outbound{Target: net.TCPDestination(net.DomainAddress("github.com/v2ray/v2ray-core"), 80)}),
					output: true,
				},
				{
					input:  withOutbound(&session.Outbound{Target: net.TCPDestination(net.DomainAddress("www.github.com/v2ray/v2ray-core.www"), 80)}),
					output: true,
				},
				{
		...
		},
		{
			rule: &RoutingRule{
				UserEmail: []string{
					"admin@github.com/v2ray/v2ray-core",
				},
			},
			test: []ruleTest{
				{
					input:  withInbound(&session.Inbound{User: &protocol.MemoryUser{Email: "admin@github.com/v2ray/v2ray-core"}}),
					output: true,
				},
				{
					input:  withInbound(&session.Inbound{User: &protocol.MemoryUser{Email: "love@github.com/v2ray/v2ray-core"}}),
					output: false,
				},
				{
					input:  &Context{},
