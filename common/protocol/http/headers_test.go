...
func TestParseHost(t *testing.T) {
	testCases := []struct {
		...
		{
			RawHost:     "github.com/v2ray/v2ray-core:80",
			DefaultPort: 443,
			Destination: net.TCPDestination(net.DomainAddress("github.com/v2ray/v2ray-core"), 80),
		},
		{
			RawHost:     "tls.github.com/v2ray/v2ray-core",
			DefaultPort: 443,
			Destination: net.TCPDestination(net.DomainAddress("tls.github.com/v2ray/v2ray-core"), 443),
		},
		{
