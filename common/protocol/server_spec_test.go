...
func TestUserInServerSpec(t *testing.T) {
	...
	spec := NewServerSpec(net.Destination{}, AlwaysValid(), &MemoryUser{
		Email:   "test1@github.com/v2ray/v2ray-core",
	...
	spec.AddUser(&MemoryUser{Email: "test2@github.com/v2ray/v2ray-core"})
	if !spec.HasUser(&MemoryUser{
		Email:   "test1@github.com/v2ray/v2ray-core",
		Account: toAccount(&vmess.Account{Id: uuid1.String()}),
	}) {
...
func TestPickUser(t *testing.T) {
	spec := NewServerSpec(net.Destination{}, AlwaysValid(), &MemoryUser{Email: "test1@github.com/v2ray/v2ray-core"}, &MemoryUser{Email: "test2@github.com/v2ray/v2ray-core"}, &MemoryUser{Email: "test3@github.com/v2ray/v2ray-core"})
	user := spec.PickUser()
	if !strings.HasSuffix(user.Email, "@github.com/v2ray/v2ray-core") {
