...
func TestExpiredCertificate(t *testing.T) {
	...
	expiredCert := cert.MustGenerate(caCert, cert.NotAfter(time.Now().Add(time.Minute*-2)), cert.CommonName("www.github.com/v2ray/v2ray-core"), cert.DNSNames("www.github.com/v2ray/v2ray-core"))
...
func BenchmarkCertificateIssuing(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		delete(tlsConfig.NameToCertificate, "www.github.com/v2ray/v2ray-core")
